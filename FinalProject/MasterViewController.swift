...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let addButton = UIBarButtonItem(barButtonSystemItem: .Add, target: self, action: "goToAddHouse:")
    ...
    func goToAddHouse(sender: AnyObject) {
        
        self.performSegueWithIdentifier("toAddHouse", sender: self)
...
//        newManagedObject.setValue("test name", forKey: "name")
//        
//        // Save the context.
//        do {
//            try context.save()
